...
- Updated dependencies [5fd9297]
  - @photonjs/core@0.1.19-beta.0
  - @photonjs/runtime@0.1.15-beta.0

## 0.1.20

### Patch Changes

- 866f41d: fix: ensure static files copy if root is defined
...
- 3624066: fix: .vercel folder should ignore root override
...
- b370ef5: feat: simpler vercel adapter if using srvx
...
- Updated dependencies [e148965]
  - @photonjs/runtime@0.1.5
