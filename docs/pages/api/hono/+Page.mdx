...
<PackageInfo
  name="@photonjs/hono"
  description="Hono adapter for Photon, enabling ultrafast edge applications."
  version="0.0.7"
  status="alpha"
  npmUrl="https://www.npmjs.com/package/@photonjs/hono"
  githubUrl="https://github.com/photon-js/photon/tree/main/packages/hono"
/>

<InstallCommand packages={["@photonjs/hono", "hono"]} />
...
<NextSteps steps={[
  {
    ...
    description: "Deploy Hono apps to Cloudflare Workers",
  ...
  },
  {
    ...
    description: "Explore the official Hono documentation",
    url: "https://hono.dev",
    external: true
  }
]} />
