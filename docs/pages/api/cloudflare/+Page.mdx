import { PackageInfo, InstallCommand, NextSteps } from '../../../components'

<PackageInfo
  name="@photonjs/cloudflare"
  description="Cloudflare Workers and Pages adapter for Photon applications."
  version="0.0.14"
  status="alpha"
  npmUrl="https://www.npmjs.com/package/@photonjs/cloudflare"
  githubUrl="https://github.com/photon-js/photon/tree/main/packages/cloudflare"
/>

<InstallCommand packages="@photonjs/cloudflare" />
...
<NextSteps steps={[
  {
    ...
    description: "Learn about deploying to Cloudflare",
    url: "/guide/deploy/cloudflare"
  },
  {
    title: "Hono Integration",
    description: "Explore Hono server framework integration",
    url: "/api/hono"
  },
  {
    title: "Cloudflare Workers Docs",
    description: "Check official Cloudflare Workers documentation",
