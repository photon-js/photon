...
```bash
npm install @photonjs/runtime @universal-middleware/core
```
...
- Study the [awesome-framework example](https://github.com/photon-js/photon/tree/main/example/awesome-framework)
- Explore [Vike's integration](https://github.com/vikejs/vike-server/tree/magne4000/dev) for advanced patterns
- Ask questions in [GitHub Discussions](https://github.com/photon-js/photon/discussions) for integration support
