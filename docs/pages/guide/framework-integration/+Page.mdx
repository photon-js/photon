import { BetaWarning, InstallCommand, NextSteps } from '../../../components'

<BetaWarning message="Framework integration APIs are in alpha and may change." />
...
<NextSteps steps={[
  ...
  },
  {
    ...
    url: "https://github.com/vikejs/vike-photon",
    external: true
  },
  {
    title: "Get Support",
