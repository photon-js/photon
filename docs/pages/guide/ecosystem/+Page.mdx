...
<AlphaWarning message="The Photon ecosystem is growing as the project matures." />
...
Running on Node/Bun/Deno is supported out-of-the-box. Additional deployment targets require platform-specific adapters:
...
<NextSteps steps={[
  {
    title: "Try Vike",
    description: "Experience Photon through a complete framework",
    url: "https://vike.dev",
    external: true
  },
  {
    title: "Build Your Framework",
    description: "Learn how to create frameworks with Photon",
    url: "/guide/concepts"
  },
  {
